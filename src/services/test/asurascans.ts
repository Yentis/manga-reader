...
async function readUrl (site: BaseSite): Promise<void> {
  ...
  desired.chapterUrl = 'https://asura.gg/2226495089-mookhyang-the-origin-chapter-47/'
...
async function readUrlAdvanced (): Promise<void> {
  const testUrl = 'https://asura.gg/?p=36093'
  ...
  desired.chapterUrl = 'https://asura.gg/2226495089-solo-bug-player-chapter-88/'
...
async function search (site: BaseSite): Promise<void> {
  ...
  desired.chapter = '47'
  desired.url = 'https://asura.gg/?p=36483'
