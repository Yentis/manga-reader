...
async function readUrlDotChapter (): Promise<void> {
  ...
  desired.chapterUrl = 'https://reset-scans.com/devmax/the-unwanted-undead-adventurer/chapter-46-1/'
  desired.chapterNum = 46.1
  desired.chapterDate = '13 days ago'
