...
async function readUrl (site: BaseSite): Promise<void> {
  ...
  desired.chapterUrl = 'https://leviatanscans.com/am/manga/the-throne/30/'
...
async function readUrlWrongSeasonOrder (): Promise<void> {
  ...
  desired.chapterUrl = 'https://leviatanscans.com/am/manga/survivor-story-of-a-sword-king-in-a-fantasy-world/season-2/105/'
...
async function readUrlCorrectSeasonOrder (): Promise<void> {
  ...
  const manga = await getMangaInfo(url, SITE_TYPE)
  const desired = new Manga(url, SITE_TYPE)
  desired.chapter = '77 - Season 2 - Ch 14'
  ...
  desired.chapterUrl = 'https://leviatanscans.com/am/manga/tale-of-a-scribe-who-retires-to-the-countryside/77/'
...
async function search (site: BaseSite): Promise<void> {
  ...
  desired.chapter = '188'
  desired.url = 'https://leviatanscans.com/am/manga/burning-effect/'
