...
async function readUrlWrongSeasonOrder (): Promise<void> {
  ...
  desired.chapterUrl = 'https://leviatanscans.com/el/manga/survivor-story-of-a-sword-king-in-a-fantasy-world/season-2/97/'
  desired.chapterNum = 97
