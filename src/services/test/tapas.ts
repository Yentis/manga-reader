...
async function readUrl (site: BaseSite): Promise<void> {
  ...
  desired.chapter = `${chapter}. The Hero's Reward`
  ...
  desired.chapterUrl = 'https://tapas.io/episode/2881115'
...
async function readUrlReverseOrder (): Promise<void> {
  ...
  desired.image = 'https://us-a.tapas.io/sa/7e/923721d0-86a3-4679-a929-4efe5945c10f_z.jpg'
