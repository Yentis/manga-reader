...
async function readUrl (site: BaseSite): Promise<void> {
  ...
  desired.chapterUrl = 'https://tapas.io/episode/2640590'
...
async function readUrlReverseOrder (): Promise<void> {
  ...
  desired.chapterUrl = 'https://tapas.io/episode/2625500'
