...
async function readUrl (site: BaseSite): Promise<void> {
  ...
  desired.chapterUrl = 'https://flamescans.org/1667646061-the-way-of-the-househusband-chapter-89/'
...
async function search (site: BaseSite): Promise<void> {
  ...
  desired.chapter = '39'
  desired.url = 'https://flamescans.org/tent/series/1667646121-berserk-of-gluttony/'
